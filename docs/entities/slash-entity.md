# SlashEntity : Mortar::Entity (blade/swipe)
...
- [Entity base](entity-base.md) -- Mortar::Entity base class, CreateEntity factory
- [Fruit entity](fruit.md) -- Fruit struct and functions
- [Bomb entity](bomb.md) -- Bomb struct and functions
- [Splat Entity](splat-entity.md) -- juice splat spawned by slash
