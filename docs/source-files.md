...
### Rendering
| Source File | Address | Port Status |
|-------------|---------|-------------|
| MatrixManager.cpp | 0x0019e5cc | Ported (simplified) |
| MatrixStack.cpp | 0x0019e940 | Ported (simplified) |
| DisplayManagerBada.cpp | 0x0019e13c | Replaced by SDL Renderer |
| MortarCamera.cpp | 0x0019ebe4 | Ported |
| Geometry.cpp | 0x001a0114 | TODO |
| Geometry_Bada.cpp | 0x001a37f8 | N/A (platform-specific) |
| Mesh.cpp | 0x001b14a8 | Partial (MMD loader) |
| Mesh_Bada.cpp | 0x001941b4 | N/A (platform-specific) |
| Model.cpp | 0x00193488 | TODO |
| Font_Common.cpp | 0x00199d34 | TODO |
| BakedString.cpp | 0x0019822c | TODO |
| Colour.cpp | 0x00183fec | Ported |
| DefaultIndexStreams_Bada.cpp | 0x001b7d2c | N/A |
| DefaultVertexStreams_Bada.cpp | 0x001b8664 | N/A |
| VertexElement.cpp | 0x001b7b28 | TODO |
...
| Animation.cpp | 0x001ad628 | TODO (low priority) |
| ResourceLoader.cpp | 0x001b4694 | TODO |
...
| SoundManager_MAM.cpp | 0x0018cc30 | TODO (SDL audio) |
...
| ActorManager.cpp | 0x00170874 | Ported |
...
|----------|-------|--------|------|------|-----|
| Engine Core | 37 | 7 | 14 | 8 | 8 |
| Game Application | 11 | 8 | 3 | 0 | 0 |
| Game Entities | 12 | 3 | 9 | 0 | 0 |
...
| **Total** | **142** | **22** | **85** | **27** | **8** |

**22 files ported, 85 TODO, 27 skipped (online/multiplayer/platform), 8 N/A (platform-specific)**
