#ifndef MORTAR_MATH3D_H
#define MORTAR_MATH3D_H

#include <cmath>
#include <cstring>

// Standalone helpers for raw float[16] column-major matrices.
// Used by game code that manipulates arrays directly.
