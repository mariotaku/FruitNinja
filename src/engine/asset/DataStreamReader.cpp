...
// Body: DataStreamReader(this, *(source+0x04), size_from_r2, *(source+0x0c))
//   i.e. initialises *this from source.m_pCursor with the remaining byte count.
// TODO: v1.6.1 0x00250c08 (DataStreamReader::MakeSubReader) -- binary mangled name
//   may encode source as unsigned long (DataStreamReader* by address); verify against
//   binary symbol table. Signature here uses DataStreamReader& for clarity.
