...
// File-static g_BackgroundTexture (SmartPtr<Mortar::Texture>) at BSS 0x231500
...
// Binary: SmartPtr<Texture> at _ZL17backgroundTexture.
static SmartPtr<Mortar::Texture> g_BackgroundTexture;
...
//   SmartPtr<Texture> tmp; TextureManager::LoadLocalisedTexture(&tmp, buf);
...
void ChangeBackground(const char* texName) {
    ...
    SmartPtr<Mortar::Texture> tmp = Mortar::TextureManager::LoadLocalisedTexture(buf);
    g_BackgroundTexture = tmp;
}
