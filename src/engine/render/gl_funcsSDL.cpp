...
// glClearDepthf is an ES1 entry point; on every desktop GL driver it's
// either absent (mingw / MSVC opengl32.lib, some libGL builds without
// ARB_ES2_compatibility) or marginally available. Forward to glClearDepth
// (GL 1.0 baseline -- always exported). The float -> double cast is exact
// for representable values.
//
// MSVC C4273 ("inconsistent dll linkage") fires because SDL_opengl.h
// declares this with dllimport. The link picks our definition; the
