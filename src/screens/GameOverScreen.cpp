...
// DIFFERS: original = game_work+0x614 (port has not extended game_work that far);
//   using file-local cached Font SmartPtr. v1.6.1 GameOverScreen::Initialise @0x00187c90.
