...
public:
    ...
    // PlayAlternateImpactSound @ 0x00113054 — delegates to m_pCurrentSlashMod->m_ImpactSounds.PlaySound.
    ...
    // SetSwipeLoodVol @ 0x00111ffc — set looping-swipe desired volume on the
