...
// BSS @ 0x001f3e4c (GOT[0x7478]): last combo-streak fruit type (Fruit::s_consecutiveType).
// Binary sentinel is -1 (0xFFFFFFFF) at cold-boot / after game-over.
// TODO (Tier-2): FruitSaveData +0x74 (combo fruit type) / +0x78 (combo count)
// save/restore via WaveManager::Resume and SaveCurrentData -- see
// docs/engine/scorecontrol-combo-source.md.
int g_ComboFruitType = -1;
