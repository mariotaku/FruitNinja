...
{
    CHECK((int)Mortar::FONT_EFFECT_NONE == 0);
    CHECK((int)Mortar::FONT_EFFECT_BOLD == 1);
...
static void test_effect_base_fields()
{
    ...
    base.m_Weight   = 2.0f;
    base.m_FmtCount = 3u;
    base.m_Flag     = (uint8_t)Mortar::FONT_EFFECT_BOLD;
    ...
    CHECK(base.m_Flag == (uint8_t)Mortar::FONT_EFFECT_BOLD);
