...
For the RE + port verification pipeline, **start at [`docs/re-pipeline.md`](../docs/re-pipeline.md)** — the canonical end-to-end stage map. Each subdir has its own README index.
