...
Usage:
  ...
  # Phase 2 (host):
  python tools/asm-verify/bindiff/discover-arm-mode.py
...
ASM_VERIFY_DIR = os.path.abspath(os.path.join(SCRIPT_DIR, ".."))
PROJECT_ROOT = os.path.abspath(os.path.join(SCRIPT_DIR, "..", "..", ".."))

MANIFEST_PATH = os.path.join(ASM_VERIFY_DIR, "manifest.generated.toml")
...
def write_cmake_fragment(arm_files):
    ...
    with open(OUTPUT_CMDS, "w") as f:
        f.write("# Auto-generated by tools/asm-verify/bindiff/discover-arm-mode.py\n")
