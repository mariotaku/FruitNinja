...
Binary class-layout / RTTI **reference** generators — **stage 10** of [the pipeline](../README.md#pipeline). Outputs (JSON) land in `tmp/`; these are reviewed references for struct-size asserts, not auto-gates (relates to tasks #76/#77).
